...
public class AdminController {
    ...
    @Operation(summary = "역할 ID로 조회", description = "특정 역할 ID에 해당하는 역할을 조회합니다.")
    ...
    @Operation(summary = "새 역할 생성", description = "새로운 역할을 생성합니다.")
    ...
    @Operation(summary = "역할 업데이트", description = "특정 역할 ID에 해당하는 역할을 업데이트합니다.")
    ...
    @Operation(summary = "역할 삭제", description = "특정 역할 ID에 해당하는 역할을 삭제합니다.")
    ...
    @Operation(summary = "모든 메뉴 리소스 조회", description = "시스템에 등록된 모든 메뉴 리소스를 조회합니다.")
    ...
    @Operation(summary = "메뉴 리소스 ID로 조회", description = "특정 메뉴 리소스 ID에 해당하는 메뉴 리소스를 조회합니다.")
    ...
    @Operation(summary = "새 메뉴 리소스 생성", description = "새로운 메뉴 리소스를 생성합니다.")
    ...
    @Operation(summary = "메뉴 리소스 업데이트", description = "특정 메뉴 리소스 ID에 해당하는 메뉴 리소스를 업데이트합니다.")
    ...
    @PutMapping("/resources/menu/{resourceId}")
    ...
    @Operation(summary = "메뉴 리소스 삭제", description = "특정 메뉴 리소스 ID에 해당하는 메뉴 리소스를 삭제합니다.")
    @ApiResponse(responseCode = "204", description = "메뉴 리소스가 성공적으로 삭제되었습니다.")
    @DeleteMapping("/resources/menu/{resourceId}")
    ...
    // --- User Management ---
    @Operation(summary = "모든 사용자 및 역할 조회", description = "시스템에 등록된 모든 사용자와 해당 사용자의 역할을 조회합니다.")
    ...
    @Operation(summary = "사용자 활성화", description = "특정 사용자를 활성화합니다.")
    ...
    @Operation(summary = "사용자 로그인 실패 횟수 초기화", description = "특정 사용자의 로그인 실패 횟수를 초기화하여 계정 잠금을 해제합니다.")
    @ApiResponse(responseCode = "200", description = "로그인 실패 횟수가 성공적으로 초기화되었습니다.")
    @ApiResponse(responseCode = "404", description = "사용자를 찾을 수 없습니다.")
    @PutMapping("/users/{userName}/reset-login-failure")
    ...
    @Operation(summary = "사용자로부터 역할 제거", description = "특정 사용자로부터 역할을 제거합니다.")
    ...
    @Operation(summary = "역할에 리소스 추가", description = "특정 역할에 리소스를 추가하여 매핑합니다.")
    ...
    @Operation(summary = "역할에서 리소스 제거", description = "특정 역할에서 리소스를 제거합니다.")
    ...
    @Operation(summary = "역할에 할당된 리소스 조회", description = "특정 역할에 할당된 모든 리소스를 조회합니다.")
