...
public class AttachController {
    ...
    @Operation(summary = "파일 업로드 및 첨부 생성", description = "여러 파일을 업로드하여 새로운 첨부 묶음을 생성.")
    ...
    @Operation(summary = "모든 첨부파일 목록 조회 (관리자용)", description = "시스템에 업로드된 모든 첨부파일 목록을 페이징하여 조회. 관리자만 접근 가능.")
    ...
    @PreAuthorize("hasRole('ADMIN')") // 관리자 권한 필요
    @Operation(summary = "모든 첨부 묶음 목록 조회 (관리자용)", description = "시스템에 업로드된 모든 첨부 묶음 목록을 페이징하여 조회. 관리자만 접근 가능.")
    ...
    @Operation(summary = "첨부파일 논리적 삭제", description = "파일 ID를 이용해 특정 파일을 논리적으로 삭제하고, FTP 서버에서도 물리적으로 삭제.")
    ...
    @Operation(summary = "첨부 묶음 전체 논리적 삭제", description = "첨부 ID를 이용해 해당 묶음에 속한 모든 파일을 논리적으로 삭제하고, FTP 서버에서도 물리적으로 삭제.")
    ...
    @Operation(summary = "개별 첨부파일 다운로드", description = "파일 ID를 이용해 특정 첨부파일을 다운로드.")
    ...
    @Operation(summary = "첨부 묶음 ZIP 다운로드", description = "첨부 ID를 이용해 해당 묶음에 포함된 모든 파일을 ZIP 파일로 압축하여 다운로드.")
